export const crossLendAbi = [
  ...
  {
    inputs: [
      { internalType: 'enum FinancialType', name: '_type', type: 'uint8' },
      { internalType: 'uint256', name: 'dayTimes', type: 'uint256' },
      { internalType: 'uint256', name: 'crfiInterestRate', type: 'uint256' },
      { internalType: 'uint256', name: 'cfilInterestRate', type: 'uint256' },
    ],
    name: 'AddPackage',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'enum FinancialType', name: 'fType', type: 'uint8' },
      { internalType: 'uint256', name: 'crfiInterestRate', type: 'uint256' },
      { internalType: 'uint256', name: 'cfilInterestRate', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: 'enum FinancialType', name: 'Type', type: 'uint8' },
          { internalType: 'uint256', name: 'deleteFlag', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'id', type: 'uint256' },
      { internalType: 'uint256', name: 'nowInvestCRFI', type: 'uint256' },
      { internalType: 'uint256', name: 'nowInvestCFil', type: 'uint256' },
      { internalType: 'uint256', name: 'totalAffCRFI', type: 'uint256' },
      { internalType: 'uint256', name: 'totalAffTimes', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    outputs: [
      ...
      },
      {
        components: [
          { internalType: 'uint256', name: 'Amount', type: 'uint256' },
          { internalType: 'uint256', name: 'ParamCRFI', type: 'uint256' },
          { internalType: 'uint256', name: 'FixInterestCRFI', type: 'uint256' },
          { internalType: 'uint256', name: 'ParamCFil', type: 'uint256' },
          { internalType: 'uint256', name: 'FixInterestCFil', type: 'uint256' },
          { internalType: 'uint256', name: 'NowCRFIInterest', type: 'uint256' },
          { internalType: 'uint256', name: 'NowCFilInterest', type: 'uint256' },
        ],
      ...
      },
      {
        components: [
          ...
          { internalType: 'uint256', name: 'NowInterest', type: 'uint256' },
        ],
  ...
  },
  {
    ...
    outputs: [
      ...
      },
      {
        components: [
          { internalType: 'enum FinancialType', name: 'Type', type: 'uint8' },
          { internalType: 'uint256', name: 'ChangeFlag', type: 'uint256' },
          {
            internalType: 'uint256',
            name: 'CRFIInterestRate',
            type: 'uint256',
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'nowInvestCRFI', type: 'uint256' },
      { internalType: 'uint256', name: 'nowInvestCFil', type: 'uint256' },
      { internalType: 'uint256', name: 'cfilInterestPool', type: 'uint256' },
      { internalType: 'uint256', name: 'crfiInterestPool', type: 'uint256' },
      { internalType: 'uint256', name: 'crfiRewardTotal', type: 'uint256' },
      { internalType: 'uint256', name: 'cfilLendingTotal', type: 'uint256' },
      { internalType: 'uint256', name: 'avaiCFilAmount', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'calcCFilToSFil',
    outputs: [{ internalType: 'uint256', name: 'sfil', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    name: 'calcSFilToCFil',
    outputs: [{ internalType: 'uint256', name: 'cfil', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
